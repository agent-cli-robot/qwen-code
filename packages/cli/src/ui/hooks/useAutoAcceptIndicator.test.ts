...
import type { Config as ActualConfigType } from '@agent-cli/agent-cli-core';
import { Config, ApprovalMode } from '@agent-cli/agent-cli-core';
  ...
  beforeEach(() => {
    ...
    (
      ...
      const instance: MockConfigInstanceShape = {
        ...
        getAgentMdFileCount: vi.fn().mockReturnValue(0) as Mock<() => number>,
        getToolRegistry: vi
          .fn()
